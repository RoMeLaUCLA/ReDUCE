...
assert item_list[0].return_flat_feature() == [1, 4, -1, 10, 5]
assert item_list[1].return_flat_feature() == [2, 5, -2, 20, 10]
assert item_list[2].return_flat_feature() == [3, 6, -3, 30, 15]
...
assert shelf.return_flat_feature() == [1, 4, -1, 10, 5, 2, 5, -2, 20, 10, 3, 6, -3, 30, 15, 25, 25]
print(shelf.return_stored_item_centers())
assert np.all(shelf.return_stored_item_centers() == np.array([[1, 4], [2, 5], [3, 6]]))

print(shelf.return_stored_item_heights())
assert shelf.return_stored_item_heights() == height

print(shelf.return_stored_item_widths())
assert shelf.return_stored_item_widths() == width

print(shelf.return_stored_item_angles())
assert shelf.return_stored_item_angles() == angle
...
assert shelf2.return_flat_feature() == [1, 4, -1, 10, 5, 2, 5, -2, 20, 10, 3, 6, -3, 30, 15]
